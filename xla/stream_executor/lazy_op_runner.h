...
struct FusedMHAOp {
  ...
  RunnerFromAlgorithmDesc(const AlgorithmDesc& desc, Config config,
    ...
    return stream->FusedMHARunnerFromDesc(
        ...
        config.activation_descriptor, config.mask_descriptor, config.bias_descriptor, 
        config.scale, config.dropout_rate, config.seed, config.is_flash_attention);
  }
};
...
struct FusedMHABackwardOp {
  ...
  RunnerFromAlgorithmDesc(const AlgorithmDesc& desc, Config config,
    ...
    return stream->FusedMHABackwardRunnerFromDesc(
        ...
        config.mask_descriptor, config.d_bias_descriptor, config.fwd_output_descriptor,
        config.scale, config.dropout_rate, config.seed, config.is_flash_attention);
  }
};
